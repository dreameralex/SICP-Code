...
forget_value(C, "user");
console.log("F = 212");
set_value(F, 212, "user"); //Implementing the constraint system
// – has_value(connector)
...
function probe(name, connector) {
  ...
  function me(request) {
    return request === "I_have_a_value" ? process_new_value() : request === "I_lost_my_value" ? process_forget_value() : Error(request, "unknown request -- probe");
  }
